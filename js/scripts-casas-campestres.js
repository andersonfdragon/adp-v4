...
$(document).ready(function(){
  $("#img_01_pc").click(function(){
      ...
      $("#07_pc").removeClass("active");
      $("#08_pc").removeClass("active");
...
$(document).ready(function(){
  $("#img_07_pc").click(function(){
      ...
      $("#05_pc").removeClass("active");
      $("#08_pc").removeClass("active");
      $("#07_pc").addClass("active");
  });
});

$(document).ready(function(){
  $("#img_08_pc").click(function(){
      $("#01_pc").removeClass("active");
      $("#02_pc").removeClass("active");
      $("#03_pc").removeClass("active");
      $("#04_pc").removeClass("active");
...
function submitForm_xs(){
  ...
  $.ajax({
      type: "POST",
      url:  "php/process_form_casas_campestres_xs.php",
      ...
      success: function(text){
          if (text == "success"){
              formSuccess_xs();
              window.location.href = "mensaje_enviado_form_casas_campestres_xs.html";
          } else {
...
function submitForm_web(){
  ...
  $.ajax({
      type: "POST",
      url:  "php/process_form_casas_campestres_web.php",
      ...
      success: function(text){
          if (text == "success"){
              formSuccess_web();
              window.location.href = "mensaje_enviado_form_casas_campestres_web.html";
          } else {
